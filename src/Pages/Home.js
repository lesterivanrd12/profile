      ...
      <main>
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
            <div>
              {/* Profile Image */}
                <div className="flex justify-center pb-10 lg:min-w-0 lg:flex-1" aria-label="Global">
                    <a href="#" className="-m-1.5 p-1.5">
                        <span className="sr-only">Your Company</span>
                        <img className="h-20 rounded-full" src="https://scontent.fcgy2-1.fna.fbcdn.net/v/t39.30808-6/298170539_5322970771120049_8684873806234270549_n.jpg?stp=cp6_dst-jpg&_nc_cat=107&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeHECCqrSjH0AQwRYdgErdFbbvyp0oKcphNu_KnSgpymE4kcNgQRLI3Frv0l66iY-WB9D9DF9p9LPYoWP4trdTE3&_nc_ohc=rrvc-FpexbQAX8UN2yH&_nc_ht=scontent.fcgy2-1.fna&oh=00_AfBwMe24rq02WPxWGq8GSJosBM3MCZck_UTnJvAPV27mLw&oe=637BAEF9" alt="" />
                    </a>
                </div>
              <div>
                ...
                <i className="bi bi-linkedin px-3">
